"""
Base Django settings for CrowdFund project.
...
# Note the additional parent directory to account for the settings package
...
LOGIN_REDIRECT_URL = '/'  # Fallback redirect for authenticated users
...
INSTALLED_APPS = [
    ...
    # Original apps
    'funding',  # Legacy app - will be phased out after migration
    'accounts',
    'core',
    'utils',  # Add utils app for our utilities
    # New modularized apps
